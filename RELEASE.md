# Pubblicare Kerberus 0.7.0

La versione applicativa ha una sola sorgente in `kerberus/__init__.py`. Il metadata Python e l'installer la importano automaticamente.
...
2. Creare esclusivamente il tag `v0.7.0` sul commit da distribuire.
3. Pubblicare il branch e il tag: `git push origin main` e `git push origin v0.7.0`.
...
- `Kerberus-0.7.0-src.tar.gz`, wheel, sdist e `SHA256SUMS-source.txt`.
