...
2. Creare esclusivamente il tag `v0.8.1` sul commit da distribuire.
3. Pubblicare il branch e il tag: `git push origin main` e `git push origin v0.8.1`.
...
- `Kerberus-0.8.1-src.tar.gz`, wheel, sdist e `SHA256SUMS-source.txt`.
